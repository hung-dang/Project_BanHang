<%-- 
    ...
    Created on : Jun 14, 2021, 5:57:58 PM
    Author     : ADMIN
--%>
                    ...
                    <tbody>
                        <c:forEach items="${listMNG}" var="o">
                            <tr>
                                ...
                                <td>${o.price} $</td>
                                <td>
                                    <a href="EditProduct?pid=${o.id}"  class="edit" data-toggle="modal"><i class="fas fa-edit" data-toggle="tooltip" title="Edit"></i></a>
